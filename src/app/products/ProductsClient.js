...
export default function ProductsClient({ initialProducts = [], initialCategories = [], initialTotal = 0 }) {
  ...
  useEffect(() => {
    if (searchQuery || selectedCategory || sortBy !== 'createdAt' || sortOrder !== 'desc' || currentPage !== 1) {
      fetchProducts()
    }
